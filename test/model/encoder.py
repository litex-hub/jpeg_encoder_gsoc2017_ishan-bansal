...
def loeffler_rotation(i0, i1, k, n):
...
def loeffler_butterfly(i0, i1):
	out0 = i0 + i1
	out1 = i0 - i1
	return out0, out1

def loeffler_dct(vector):
	r = [0]*8

	# stage 1
	vector[3], vector[4] = loeffler_butterfly(vector[3], vector[4])
	vector[2], vector[5] = loeffler_butterfly(vector[2], vector[5])
	vector[1], vector[6] = loeffler_butterfly(vector[1], vector[6])
	vector[0], vector[7] = loeffler_butterfly(vector[0], vector[7])

	# stage 2
	vector[0], vector[3] = loeffler_butterfly(vector[0], vector[3])
	vector[1], vector[2] = loeffler_butterfly(vector[1], vector[2])
	vector[4], vector[7] = loeffler_rotation(vector[4], vector[7], 1, 3)
	vector[5], vector[6] = loeffler_rotation(vector[5], vector[6], 1, 1)

	# stage 3
	vector[7], vector[5] = loeffler_butterfly(vector[7], vector[5])
	vector[4], vector[6] = loeffler_butterfly(vector[4], vector[6])
	vector[0], vector[1] = loeffler_butterfly(vector[0], vector[1])
	vector[2], vector[3] = loeffler_rotation(vector[2], vector[3], sqrt2, 6)

	# stage 4
	r[1], r[7] = loeffler_butterfly(vector[7], vector[4])
	r[5] = sqrt2 * vector[6]
	r[3] = sqrt2 * vector[5]
	r[6] = vector[3]
	r[2] = vector[2]
