...
from litejpeg.core.crs import YCbCr444to422, YCbCr422to444
...
class TB(Module):
    def __init__(self):
        ...
        self.comb += [
            Record.connect(self.streamer.source, self.ycbcr444to422.sink, omit=["data"]),
            ...
            Record.connect(self.ycbcr422to444.source, self.logger.sink, omit=["y", "cb", "cr"]),
