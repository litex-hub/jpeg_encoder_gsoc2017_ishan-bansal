...
from litejpeg.core.csc import ycbcr2rgb_coefs, YCbCr2RGB
...
class TB(Module):
    def __init__(self):
        ...
        self.comb += [
            Record.connect(self.streamer.source, self.ycbcr2rgb.sink, omit=["data"]),
            ...
            Record.connect(self.ycbcr2rgb.source, self.logger.sink, omit=["r", "g", "b"]),
